				...
				<div class="modal-body">
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-12" id="infoEditarFacultad"></div>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<button class="btn btn-danger" title="BORRAR FACULTAD" onclick="modalFacultad(3,'.$id.')">BORRAR</button>
					<button type="button" class="btn btn-info" onclick="actualizarFacultad('.$id.')" title="ACTUALIZAR">ACTUALIZAR</button>
