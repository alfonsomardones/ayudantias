	...
	if($_SESSION['tipo_usuario']=='ADMINISTRADOR SUPERIOR')
	{
		if(isset($_POST['id']))
		{
			...
			<div class="modal-body">
				<p class="lead">¿Desea confirmar borrar carrera?</p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-danger" onclick="borrarCarrera('.$_POST['id'].')" title="BORRAR CARRERA">BORRAR</button>
				<button type="button" class="btn btn-info" onclick="modalCarrera(2,'.$_POST['id'].')" title="ATRÁS">ATRÁS</button>
