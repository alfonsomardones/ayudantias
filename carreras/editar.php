...
if(isset($_SESSION['id_usuario']))
{
	if($_SESSION['tipo_usuario']=='ADMINISTRADOR SUPERIOR')
	{
		if(isset($_POST['id']))
		{
			...
			$sql = 'SELECT * FROM carreras WHERE id_carrera='.$_POST['id'];
				...
				<div class="modal-body">
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-12" id="infoEditarCarrera"></div>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<button class="btn btn-danger" title="BORRAR CARRERA" onclick="modalCarrera(3,'.$id.')">BORRAR</button>
					<button type="button" class="btn btn-info" onclick="actualizarCarrera('.$id.')" title="ACTUALIZAR">ACTUALIZAR</button>
