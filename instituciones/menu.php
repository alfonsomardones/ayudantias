...
if(isset($_SESSION['id_usuario']))
{
	if($_SESSION['tipo_usuario']=='ADMINISTRADOR SUPERIOR')
	{
		...
		<div class="col-12 col-md-2">
			<div class="form-group">
				<button class="btn btn-info btn-block btn-sm" title="REALIZAR BÚSQUEDA" onclick="mostrarInstituciones()"><span class="glyphicon glyphicon-search d-block d-md-none"></span><span class="d-none d-md-block"> BUSCAR</span></button>
			</div>
		</div>
		';
	}
