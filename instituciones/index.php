		...
		<div class="container-fluid">
			...
			<div class="row contenido-seccion">
				...
				<div class="col-6 col-md-2">
					<button type="button" class="btn btn-outline-info btn-block" data-toggle="modal" data-target="#modalInstitucion" onclick="modalInstitucion(1)" title="REGISTRAR NUEVA INSTITUCIÓN"><span class="glyphicon glyphicon-user d-block d-md-none"></span><span class="d-none d-md-block"> NUEVO</span></button></div>
				<div class="col-6 col-md-2">
