		...
		<div class="modal-body">
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-12" id="infoRegistroInstitucion"></div>
				</div>
			</div>
		</div>
		<div class="modal-footer">
			<button type="button" class="btn btn-info" onclick="registrarInstitucion()" title="REGISTRAR INSTITUCIÓN">REGISTRAR</button>
