<nav class="navbar fixed-top navbar-expand-sm navbar-dark">
	...
	<div class="collapse navbar-collapse justify-content-end" id="nav-content">   
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link" href="#" data-toggle="modal" data-target="#ModalSeccion1" onclick="ObtenerModalSeccion1(3,0)">Descargas</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="#" data-toggle="modal" data-target="#ModalSeccion1" onclick="ObtenerModalSeccion1(4,0)">Contacto</a>
			</li>
			<li class="nav-item">
				<div class="dropdown">
					<?php
						if(isset($_SESSION['id_usuario']))
						{
							...
							echo '</button>';
							echo '<button class="btn btn-dark" type="button" href="#" data-toggle="modal" data-target="#ModalSeccion1" onclick="ObtenerModalSeccion1(6,0)"><span class="glyphicon glyphicon-log-out"></span></button>';
							echo'
								<div class="dropdown-menu dropdown-menu-right scrollable-menu" aria-labelledby="btn-InicioSesion">
									...
									<a class="dropdown-item" href="#" data-toggle="modal" data-target="#ModalSeccion1"  onclick="ObtenerModalSeccion1(5,0)">Editar perfil</a>
							...
							if ($_SESSION['nombre_tipo_usuario']=="Administrador Máster")
							{
								...
								echo '<a class="dropdown-item" href="#" onclick="BarraControl(5,1)">Estadísticas</a>';
							}
							if ($_SESSION['nombre_tipo_usuario']=="Ayudante")
							{	
								echo '<a class="dropdown-item" href="#">Mi Historial</a>';
								echo '<a class="dropdown-item" href="#">Mis Valoraciones</a>';
							}
							if ($_SESSION['nombre_tipo_usuario']=="Estudiante")
							{	
								echo '<a class="dropdown-item" href="#">Mi Historial</a>';
							}
							echo '</div>';
						...
						{
							echo '<button class="btn btn-dark" type="button" id="btn-InicioSesion" data-toggle="modal" data-target="#ModalSeccion1" onclick="ObtenerModalSeccion1(1,0)">Inicio sesión</button>';
						}
					?>
				</div>
			</li>
