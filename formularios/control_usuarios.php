		...
		if($contador>0)
		{
			...
			while ($lista = mysqli_fetch_array($resultado))
			{
				...
				echo "<tr id='filaTablaUsuarios".$id_usuario."'>
					<td>
						<input type='text' value='$nombres' name='input_nombres".$id_usuario."' id='input_nombres".$id_usuario."' class='form-control'>
					</td>
					<td>
						<input type='text' value='$apellidos' name='input_apellidos".$id_usuario."' id='input_apellidos".$id_usuario."' class='form-control'>
					</td>
					<td>
						<input type='text' value='$rut' name='input_rut".$id_usuario."' id='input_rut".$id_usuario."' class='form-control'>
					</td>
					<td>
						<input type='tel' value='$telefono' name='input_telefono".$id_usuario."' id='input_telefono".$id_usuario."' class='form-control'>
					</td>
					<td>
						<input type='text' value='$correo' 	name='input_correo".$id_usuario."' id='input_correo".$id_usuario."' class='form-control'>
					</td>
					<td>";
					...
					echo "</td>
					<td>
						<select id='input_estado".$id_usuario."' name='input_estado".$id_usuario."' class='form-control'><option value='Habilitado' ";
