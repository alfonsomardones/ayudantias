<div class="container">
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="input_nombres" id="input_nombres" placeholder="Ingrese sus Nombres" autocomplete="on" autofocus>
    </div>
    <div id="errorNombres"></div>
    <div class="form-group">
      <label for="input_apellidos">Apellidos:</label>
      <input type="text" class="form-control" name="input_apellidos" id="input_apellidos" placeholder="Ingrese sus Apellidos" autocomplete="on">
    </div>
    <div id="errorApellidos"></div>
    <div class="form-group">
      <label for="input_rut">RUT:</label>
      <input type="text" class="form-control" name="input_rut" id="input_rut" placeholder="12345678-9" autocomplete="on">
    </div>
    <div id="errorRut"></div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="tel" class="form-control" name="input_telefono" id="input_telefono" placeholder="Ingrese su Teléfono" autocomplete="on">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="email" class="form-control" name="input_correo" id="input_correo" placeholder="ejemplo@ejemplo.cl" autocomplete="on" >
    </div>
